...
echo '<head>';
echo "<link href='style1.css' type='text/css' rel='stylesheet'/>";
echo '</head>';
echo '<body>';
echo "<h3>Thanks for your Purchase</h3>";

echo '<p>Your Password is: ' . $pw . '</p><br>';
echo "<h4>Reciept</h4>";
